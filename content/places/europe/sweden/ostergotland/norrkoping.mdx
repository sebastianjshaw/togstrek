...
![](https://media.togstrek.com/europe/sweden/ostergotland/norrkoping/Johannisborgs+slottsruin-0001.jpg)
...
Norrköping's prior home for the symphony, it's not used as much by younger musicians. It's in a fairly central location with a square out front offering some artistic statues.
...
The Visualisation Centre is a modern museum based around 3D modelling and a cinema. The fourth floor offers "Decode the code" Featuring interactive examples of computer graphics. For example using gestures to change a tentacle length on a large screen.
