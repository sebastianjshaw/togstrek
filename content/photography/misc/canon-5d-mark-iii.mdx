...
ISO goes up to a whopping 102,400, though you have to enable that. The noise at that level is somewhat staggering, as you can see at [DP Review](https://www.dpreview.com/reviews/canoneos5dmarkiii) but considering that is 4 stops higher than the 1D Mark III, it gives a real chance to shoot more clearly in darkness, even if it does need work after the fact to clean the image up. The camera does have some inbuilt noise removal, and I’ll need to compare that against the 1D at low light levels.  
