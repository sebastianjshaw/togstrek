...
description: The boat is a short walk from Aktse, so make sure you leave time to
  reach it before the departure time. The trip is a short hop over Lájtávrre and
  then a hike through forest and marshland before you climb the edge of a hill.
...
heroImage:
  ...
  src: https://media.togstrek.com/hiking/kungsleden/etapp-11-aktse-prtestugan/11+-+Aktse+to+Parte-001243a3.jpg
  width: 1500
  height: 1000
  alt: Etapp 11 - Aktse - Pårtestugan
  priority: true
---
