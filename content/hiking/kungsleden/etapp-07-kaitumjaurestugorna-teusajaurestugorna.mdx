...
description: Crossing through Sjaunja, Sweden's second-largest nature reserve
  and part of Laponia's World Heritage site, the section of trail is short,
  though with a reasonably steep uphill section about halfway through. Once at
  the summit, the walk is flat, but it can be challenging to find the trail as
  much of
...
heroImage:
  ...
  src: https://media.togstrek.com/hiking/kungsleden/etapp-07-kaitumjaurestugorna-teusajaurestugorna/07+-+Kaitumajure+to+Teusajaure-000443a3.jpg
  width: 1500
  height: 1000
  alt: Etapp 07 - Kaitumjaurestugorna - Teusajaurestugorna
  priority: true
---
