...
description: Machame is nestled in the forest, and so is quite free from wind.
  It also is layed out in clearings and so each group has some small level of
...
heroImage:
  ...
  src: https://media.togstrek.com/hiking/mt-kilimanjaro/02-machame-camp-shira-camp/01+Machame+Camp+-+Shira+Camp-20220307-00843a3.jpg
  width: 1500
  height: 1000
  alt: "Kilimanjaro: Day 02 - From Machame Camp to Shira Camp"
  priority: true
---
