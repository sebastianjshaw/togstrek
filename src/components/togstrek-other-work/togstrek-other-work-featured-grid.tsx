    ...
    >
      {items.map((item) => (
        <Link
          ...
          href={item.href}
          className="togstrek-other-work-hub-featured-card group flex flex-col overflow-hidden rounded-[var(--tt-radius-sm)] border border-tt-border-muted bg-tt-surface-base outline-none transition hover:border-tt-border-accent focus-visible:ring-2 focus-visible:ring-tt-accent"
        >
