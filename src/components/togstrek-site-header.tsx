      ...
      <div className="togstrek-site-header-inner mx-auto flex h-[var(--tt-layout-header-height)] max-w-[var(--tt-layout-max-wide)] items-center justify-between gap-2 px-[var(--tt-layout-gutter)] sm:gap-4">
        ...
        >
          <Image
            ...
            priority
          />
          <span className="togstrek-site-header-title block whitespace-nowrap pb-[0.22em] pt-[0.04em] font-tt-display text-[1rem] font-semibold leading-[1.1] tracking-[var(--tt-tracking-tight)] text-tt-text-primary sm:text-[1.05rem] md:text-[1.15rem]">
            A Tog&apos;s Trek
          </span>
        </Link>
